...
// This function performs HTML escaping.  It scans a string
...
//   /fooo/bar/baz?field=value&field2=value2
//   <-- path --> ? <-------  args  ------->
//
// This class accepts a URL and splits it into a path and a dictionary
// containing the arguments' keys and their values.  All components are
// URIDecode()ed them, allowing the caller to access the components
