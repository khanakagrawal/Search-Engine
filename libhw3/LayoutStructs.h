...
struct BucketRecord {
  int32_t            chain_num_elements;  // number of elements in this
                                          // bucket's chain.
...
struct DoctableElementHeader {
  DocID_t   doc_id;
  int16_t   file_name_bytes;   // number of bytes needed to serialize the file
                               // name. note: 16-bit quantity!

  DoctableElementHeader() { }  // this constructor doesn't initialize any fields
...
struct WordPostingsHeader {
  ...
  WordPostingsHeader() { }  // this constructor doesn't initialize any fields!
...
struct DocIDElementHeader {
  ...
  DocIDElementHeader() { }  // this constructor doesn't initialize any fields!
...
struct DocIDElementPosition {
  ...
  DocIDElementPosition() { }  // this constructor doesn't initialize any fields
  explicit DocIDElementPosition(DocPositionOffset_t position_arg)
